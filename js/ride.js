...
const unicorns = ["images/unicorn-icon.png", "images/unicorn-icon-blue.png", "images/unicorn-icon-blurple.png", "images/unicorn-icon-green.png", "images/unicorn-icon-pruple.png"]
...
(function rideScopeWrapper($) {
    ...
    $(function onDocReady() {
        ...
        function setLocation(loc) {
            ...
            var myIcon = L.icon({
                iconUrl: unicorns[Math.floor((Math.random()*this.length))],
                iconSize: [25, 25],
                iconAnchor: [22, 24],
                shadowSize: [25, 25],
                shadowAnchor: [22, 24]
